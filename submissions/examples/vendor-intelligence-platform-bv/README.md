...
The core objective of **Vendor Intelligence Platform** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(225, 85%, 55%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(135, 75%, 45%)` - Secondary metrics lines.
