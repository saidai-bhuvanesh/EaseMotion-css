# Gzip vs Brotli Compression Efficiency Benchmark (CI)

## Overview

This submission addresses issue #82121 by providing a self-contained demonstration and reusable artifact for **Gzip vs Brotli Compression Efficiency Benchmark (CI)**, packaged inside `submissions/examples/gzip-vs-brotli-compression-ci-sb/` to comply with the repository contribution guidelines.
