# Unused CSS Class Extraction & Purge Efficiency Benchmark (CI)

## Overview

This submission addresses issue #82119 by providing a self-contained demonstration and reusable artifact for **Unused CSS Class Extraction & Purge Efficiency Benchmark (CI)**, packaged inside `submissions/examples/unused-css-purge-ci-sb/` to comply with the repository contribution guidelines.
