...
The core objective of **Smart Manufacturing Intelligence Platform** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(35, 90%, 50%)` - Primary branding accents.
