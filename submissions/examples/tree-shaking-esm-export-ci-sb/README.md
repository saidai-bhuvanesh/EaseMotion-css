# Tree-Shaking ESM Module Export Verification Test (CI)

## Overview

This submission addresses issue #82068 by providing a self-contained demonstration and reusable artifact for **Tree-Shaking ESM Module Export Verification Test (CI)**, packaged inside `submissions/examples/tree-shaking-esm-export-ci-sb/` to comply with the repository contribution guidelines.
