...
The core objective of **Worldwide Monitoring Grid** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(205, 90%, 50%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(330, 85%, 55%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(145, 80%, 45%)` - Callouts and interactive states.
