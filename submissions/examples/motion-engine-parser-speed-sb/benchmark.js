// Motion Engine Attribute Parser Speed Benchmark (Ops/sec) — benchmark script
...
function runBenchmark() {
  ...
  let ops = 0;
  const sample = "fade-in 300ms ease-out delay-100ms";
  for (let i = 0; i < 100000; i++) { if (sample.includes('fade-in')) ops++; }
