...
The core objective of **Global Operations Control Tower** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(210, 85%, 55%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(15, 85%, 55%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(165, 80%, 45%)` - Callouts and interactive states.
