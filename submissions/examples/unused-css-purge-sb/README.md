# Unused CSS Class Extraction & Purge Efficiency Benchmark

## Overview

This submission addresses issue #82118 by providing a self-contained demonstration and reusable artifact for **Unused CSS Class Extraction & Purge Efficiency Benchmark**, packaged inside `submissions/examples/unused-css-purge-sb/` to comply with the repository contribution guidelines.
