...
The core objective of **Enterprise Decision Intelligence Platform** is to build a premium, highly responsive engineering console demonstrating:
...
- **Secondary Color (`--secondary-hsl`)**: `hsl(140, 75%, 45%)` - Secondary metrics lines.
